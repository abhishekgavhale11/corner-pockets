...
const adminItems = [
  {
    href: "/admin/settings",
    title: "Settings",
    description: "Users and club login access.",
    icon: SettingsIcon,
    disabled: false,
  },
  {
    href: "/admin/closing",
    title: "Closing",
    description: "Manage closing tasks, cash up and audit.",
    icon: ClosingIcon,
    disabled: false,
  },
  {
  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <p className="mt-1 text-sm text-gray-500">Club management</p>
      </div>
      ...
      <div className="grid gap-4 sm:grid-cols-2">
        {adminItems.map((item) => {
          ...
          const inner = (
            <div
              className={cn(
                "flex items-center gap-4 rounded-xl border bg-white p-5 shadow-sm transition-colors",
                item.disabled
            ...
            >
              <div
                className={cn(
                  ...
                  item.disabled ? "bg-gray-100 text-gray-400" : "bg-emerald-50 text-emerald-700"
                )}
              >
                <Icon />
              </div>
