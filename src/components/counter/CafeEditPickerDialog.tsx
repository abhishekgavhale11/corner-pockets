            ...
            line.entries.map((entry) => (
              <li key={entry.id}>
                <button
                  ...
                  className="flex w-full items-center justify-between gap-2 rounded border border-gray-200 px-3 py-2 text-left hover:border-emerald-400 hover:bg-emerald-50"
                >
